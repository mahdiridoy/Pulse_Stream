...
pub struct AppState {
    ...
    pub active_addon_catalog: Option<pulse_core::providers::addons::models::AddonCatalogTarget>,
    ...
    pub update_release: Option<pulse_core::updater::Release>,
    ...
    pub pending_playback_source: Option<pulse_core::providers::models::PlaybackSource>,
    ...
    pub tv_channels: Vec<pulse_core::providers::tv::Channel>,
    ...
    pub installed_addons: Vec<pulse_core::providers::addons::models::InstalledAddon>,
    ...
    pub history: pulse_core::history::HistoryManager,
    pub favorites: pulse_core::favorites::FavoritesManager,
...
impl Default for AppState {
    fn default() -> Self {
        Self {
            ...
            history: pulse_core::history::HistoryManager::new(),
            favorites: pulse_core::favorites::FavoritesManager::new(),
...
impl AppState {
    ...
    pub fn is_selected_details_favorited(&self) -> bool {
        ...
        self.favorites
            .is_favorite(&pulse_core::models::SubjectIdentity {
    ...
    pub fn available_providers(&self) -> Vec<ProviderKind> {
        let mut providers: Vec<ProviderKind> = pulse_core::models::ProviderKind::ENABLED
            .into_iter()
    ...
    pub fn favorites_landing_items(&self) -> Vec<&pulse_core::favorites::FavoriteItem> {
        let mut items: Vec<&pulse_core::favorites::FavoriteItem> =
            self.favorites.items.iter().collect();
        items.sort_by_key(|item| std::cmp::Reverse(item.added_at));
        items.truncate(5);
        items
    }

    pub fn continue_watching_items(&self) -> Vec<&pulse_core::history::WatchHistoryItem> {
        let mut items: Vec<&pulse_core::history::WatchHistoryItem> = self
            .history
            .recent
            .iter()
...
impl AppState {
    ...
    pub fn series_synopsis(&self) -> Option<(String, String)> {
        ...
        let title = pulse_core::providers::moviebox::clean_moviebox_title(raw_title);
        let intro = details
            .description
            .as_deref()
...
mod tests {
    ...
    fn state_with(results: usize) -> AppState {
        ...
        for i in 0..results {
            state.search_results.push(pulse_core::models::SearchResult {
                id: i.to_string(),
                title: format!("T{i}"),
                stype: 1,
    ...
    fn test_favorites_landing_visible_conditions() {
        ...
        state
            .favorites
            .items
            .push(pulse_core::favorites::FavoriteItem {
